...
class __TwigTemplate_3ba5314f1787a1e4dbc6c8c4be09a5d3a81d50b83bc73d8990e686c1e7d6e47b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 0) &&  !twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 37)) &&  !twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 37))) {
    ...
    {
        return new Source("", "themes/electra/templates/menu/menu.html.twig", "C:\\xampp\\htdocs\\drupal-project\\themes\\electra\\templates\\menu\\menu.html.twig");
    }
